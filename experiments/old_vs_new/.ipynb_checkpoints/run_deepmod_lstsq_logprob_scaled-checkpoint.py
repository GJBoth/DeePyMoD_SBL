...
train_dynamic_logprob_scaled(model, X_train, y_train, optimizer, 20000, loss_func_args={'start_sparsity_update': 50000, 'sparsity_update_period': 200, 'noise': sigma})

torch.save(model.state_dict(), 'data/deepmod_lstsq_logprob_scaled.pt')